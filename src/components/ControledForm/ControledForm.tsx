  ...
  return (
    ...
    >
      <label htmlFor="name" className="grow">
        ...
        />
        {errors.name && (
          <p className="absolute text-red-400 text-sm">{errors.name.message}</p>
        )}
      </label>
      <label htmlFor="age">
        <input
        ...
        />
        {errors.age && (
          <p className="absolute text-red-400 text-sm">{errors.age.message}</p>
        )}
      </label>
      <label htmlFor="email">
        <input
      ...
      {errors.gender && (
        <p className="absolute text-red-400 text-sm">{errors.gender.message}</p>
      )}
